...
import `in`.ajm.sb_library.flashbar.util.NavigationBarPosition.LEFT
import `in`.ajm.sb_library.flashbar.util.NavigationBarPosition.RIGHT
import `in`.ajm.sb_library.flashbar.util.convertDpToPx
import `in`.ajm.sb_library.flashbar.util.getStatusBarHeightInPx
import `in`.ajm.sb_library.flashbar.view.ShadowView
...
internal class FlashbarView(context: Context) : LinearLayout(context) {
    ...
    internal fun setProgressTint(progressTint: Int?,
        ...
        val progressBar = when (position) {
            ...
            Flashbar.ProgressPosition.LEFT -> TODO()
            Flashbar.ProgressPosition.RIGHT -> TODO()
        }
