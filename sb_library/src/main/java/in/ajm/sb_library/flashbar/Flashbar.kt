    ...
    class Builder(internal var activity: Activity) {
        ...
        private fun configureAnimation() {
            enterAnimBuilder = if (enterAnimBuilder == null) {
                ...
                when (gravity) {
                    Gravity.TOP -> enterAnimBuilder!!.enter().fromTop()
                    Gravity.BOTTOM -> enterAnimBuilder!!.enter().fromBottom()
                }
            }
            ...
            exitAnimBuilder = if (exitAnimBuilder == null) {
                ...
                when (gravity) {
                    Gravity.TOP -> exitAnimBuilder!!.exit().fromTop()
                    Gravity.BOTTOM -> exitAnimBuilder!!.exit().fromBottom()
                }
            }
        }
    }
