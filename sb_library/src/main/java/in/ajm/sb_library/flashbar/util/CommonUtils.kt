package `in`.ajm.sb_library.flashbar.util
...
internal fun Activity.getNavigationBarSizeInPx(): Int {
    ...
    return if (navigationBarPosition == HeaderLayoutManager.VerticalGravity.LEFT || navigationBarPosition == HeaderLayoutManager.VerticalGravity.RIGHT) {
